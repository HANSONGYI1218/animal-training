...
export default function TrainingLectureTab() {
  const [userCurriculum, setUerCurriculum] = useState<UserCurriculumDto | null>(
    null,
  );
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      const getUserCurriculum: UserCurriculumDto =
    ...
    const getLecture = async () => {
      ...
      const getLectureCurriculums: CurriculumLectureDto[] =
